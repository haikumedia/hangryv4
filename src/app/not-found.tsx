  ...
  return (
    <Layout>
      <Container className=" relative isolate flex h-full flex-col items-center justify-center py-20 text-center sm:py-32">
        <CirclesBackground className="absolute top-1/2 left-1/2 -z-10 mt-44 w-[68.125rem] -translate-x-1/2 -translate-y-1/2 [mask-image:linear-gradient(to_bottom,white_20%,transparent_75%)] stroke-gray-300/30" />
